...
<div class="main-content">
    <section class="section">
        ...
        <div class="section-body">
            <form role="form" method="post" action="<?= base_url('Pembelian/save'); ?>">
                <?php 
                    $nota = "NOTA-".date('Ymdhis');
                    $date = date('Y-m-d');
                ?>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <select class="form-control" name="suplier" required>
                                    <option selected disabled required value="">--PILIH SUPLIER--</option>
                    ...
                    <div class="col-xl-12 col-lg-4">
                        ...
                        <tbody>
                            ...
                            <td>
                                ...
                                <td>
                                <input type="text" name="harga[]" id="harga_1" class="form-control" autocomplete="off" onkeypress='return event.charCode >= 48 && event.charCode <= 57' onkeyup="getTotal(1)" required>
                ...
                <button type="submit" class="btn btn-primary">Save Nota</button>
            </form>
        </div>
    </section>
</div>
        ...
        function getTotal(row = null) {
            if(row) {
                ...
                if(Number($("#harga_"+row).val()) <= 0){
                    ...
                    var akhir = Number($("#harga_"+row).val()) * 1;
                    akhir = akhir;
